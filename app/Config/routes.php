 ...
 */
	...
	Router::connect('/product/:slug-:id',array('controller' => 'products', 'action' => 'show'), array('pass' => array('id','slug'),'id'=>'[0-9]+','slug' => '[a-z0-9\-]+'));

	Router::connect('/categorie/:slug',array('controller' => 'posts', 'action' => 'category'), array('pass' => array('slug'),'slug' => '[a-z0-9\-]+')); 

	Router::connect('/categorieProduit/:slug',array('controller' => 'products', 'action' => 'productCategory'), array('pass' => array('slug'),'slug' => '[a-z0-9\-]+')); 
/**
